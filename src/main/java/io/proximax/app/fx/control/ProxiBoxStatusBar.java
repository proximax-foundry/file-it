 ...
 * @author thcao
 */
import io.proximax.app.fx.control.skin.ProxiBoxStatusBarSkin;
 ...
 * </pre>
 */
public class ProxiBoxStatusBar extends Control {
        
    private ProxiBoxStatusBarSkin proxiBoxStatusBarSkin = null;
    private EventHandler eventHandler;    

    /**
     * Constructs a new status bar control.
     */
    public ProxiBoxStatusBar() {        
    ...
    protected Skin<?> createDefaultSkin() {
        proxiBoxStatusBarSkin = new ProxiBoxStatusBarSkin(this);
        return proxiBoxStatusBarSkin;
    }
